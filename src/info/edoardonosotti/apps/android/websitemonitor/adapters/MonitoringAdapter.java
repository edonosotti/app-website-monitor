...
public class MonitoringAdapter extends ArrayAdapter<Website> {
	private final Context context;
	private final List<Website> objects;

	public MonitoringAdapter(Context context, int resource, List<Website> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Website w = objects.get(position);
		Monitoring m = w.getLastMonitoring();
